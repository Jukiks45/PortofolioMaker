        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="hero1-header heading1">
                    <h5 data-aos="fade-left" data-aos-duration="800">
                        ...
                        Portfolio Maker untuk Mahasiswa & Fresh Graduate
                    </h5>
                    <div class="space16"></div>
                    <h1 class="text-anime-style-3">Buat Portfolio dan CV Profesional dalam Hitungan Menit</h1>
                    <div class="space16"></div>
                    <p data-aos="fade-left" data-aos-duration="900">
                        Buat portfolio online dan CV profesional tanpa perlu kemampuan desain atau coding.
                        Cukup isi data diri, pilih template, dan unduh CV siap pakai untuk melamar kerja atau magang.
                    </p>
            ...
            <div class="col-lg-5">
                <div class="hero-images-area">
                    ...
                    <div class="elements">
                        <img src="{{ asset('assets/img/elements/elements3.png') }}" alt=""
                            class="elements3 aniamtion-key-1">
                        <img src="{{ asset('assets/img/elements/elements2.png') }}" alt=""
                            class="elements2 aniamtion-key-2">
                        <img src="{{ asset('assets/img/elements/elements1.png') }}" alt=""
                            class="elements1 keyframe5">
                    </div>
                </div>
            </div>
        </div>
